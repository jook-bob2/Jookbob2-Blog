...
const TalkLife = props => {
  ...
  const [boardState, setBoardState] = useState({
    ...
    searchKeyword: '',
    count: 0,
    brdText: props.location === undefined ? 'talkLife' : props.location.pathname.split("/")[1],
    bKinds: '02'
  });
    ...
    <div className={classes.root}>
      <div className={classes.row}>
        {props.location === undefined 
            ?
            <div><h3><CategoryIcon /> 일상관련</h3></div>
            :
            <SearchInput
                placeholder="검색하기"
