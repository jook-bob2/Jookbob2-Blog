...
public class UserController {
	...
	@DeleteMapping(value = "/userSec/{memberNo}")
	public void memberSec(@PathVariable("memberNo") Long memberNo) {
		userMapper.userSec(memberNo);
	}
	
	@PostMapping(value = "/userRestore/{memberNo}")
	public void memberRestore(@PathVariable("memberNo") Long memberNo) {
		userMapper.userRestore(memberNo);
	}
	
	@PostMapping(value = "/userSecChk")
	public void noticeDeleteChk(@RequestBody List<Long> checkArr) {
		userService.userSecChk(checkArr);
	}
	
	@PostMapping(value = "/userRestoreChk")
	public void noticeRestoreChk(@RequestBody List<Long> checkArr) {
		userService.userRestoreChk(checkArr);
	}
}
